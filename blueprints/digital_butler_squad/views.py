...
from blueprints.digital_butler_squad.serializers import AgentInstructionSerializer

class AgentInstructionViewSet(ModelViewSet):
    """
    Viewset for CRUD operations on AgentInstruction model in the Digital Butler Squad.
    """
