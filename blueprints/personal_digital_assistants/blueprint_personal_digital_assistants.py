    ...
    def metadata(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "env_vars": [
                ...
                "SERPAPI_API_KEY",
                "WP_SITES_PATH",
                "WOLFRAM_API_KEY",  # Used by mcp-wolfram-alpha for Wolfram Alpha queries.
            ],
        }
    ...
    def create_agents(self) -> Dict[str, Agent]:
        ...
        agents["Mycroft"] = Agent(
            ...
            instructions=(
                ...
                "   - Utilize Wolfram Alpha (via the mcp-wolfram-alpha MCP server) to answer computational, mathematical, "
            ...
            mcp_servers=[
                ...
                "mcp-server-reddit",
                "rag-docs",
                "mcp-wolfram-alpha"  # NEW: Added for Wolfram Alpha integration.
            ],
