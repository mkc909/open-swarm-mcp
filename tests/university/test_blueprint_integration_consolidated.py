...
class UniversityBlueprintIntegrationTests(TestCase):
    ...
    @skip("Course integration tests are currently broken due to teaching_units resolution issues.")
    ...
    @skip("Enrollment integration tests are currently broken due to course teaching_units resolution issues.")
    ...
    @skip("Assessment integration tests are currently broken due to enrollment/course issues.")
