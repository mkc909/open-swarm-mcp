...
from swarm.extensions.blueprint.blueprint_runner import (
    load_blueprint,
...
@patch("swarm.extensions.blueprint.blueprint_runner.load_blueprint")
@patch("swarm.extensions.blueprint.blueprint_runner.run_blueprint_framework")
...
def test_main_framework_mode(mock_isfile, mock_run_framework, mock_load_blueprint):
    ...
    from swarm.extensions.blueprint.blueprint_runner import main
    main()
    mock_load_blueprint.assert_called_once_with("/path/to/blueprint_valid.py")
    mock_run_framework.assert_called_once()

@patch("swarm.extensions.blueprint.blueprint_runner.load_blueprint")
@patch("swarm.extensions.blueprint.blueprint_runner.run_blueprint_interactive")
@patch("os.path.isfile", return_value=True)
